...
public class DomicilioProveePK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.onlineshop.integracion.jpa.entities.DomicilioProveePK[ proveedorTipoDocumento=" + proveedorTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
