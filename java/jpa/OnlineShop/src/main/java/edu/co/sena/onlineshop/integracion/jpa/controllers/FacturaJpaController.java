...
public class FacturaJpaController implements Serializable {
    ...
    public void create(Factura factura) {
        ...
        try {
            ...
            if (cuenta != null) {
                cuenta.getFacturaCollection().add(factura);
    ...
    public void edit(Factura factura) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (cuentaOld != null && !cuentaOld.equals(cuentaNew)) {
                cuentaOld.getFacturaCollection().remove(factura);
                cuentaOld = em.merge(cuentaOld);
            }
            if (cuentaNew != null && !cuentaNew.equals(cuentaOld)) {
                cuentaNew.getFacturaCollection().add(factura);
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            Cuenta cuenta = factura.getCuenta();
            if (cuenta != null) {
                cuenta.getFacturaCollection().remove(factura);
                cuenta = em.merge(cuenta);
            }
            em.remove(factura);
            em.getTransaction().commit();
