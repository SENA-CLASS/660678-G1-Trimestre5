 ...
 */
package edu.co.sena.onlineshop.integracion.jpa.entities;
...
public class InventarioComprasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.onlineshop.integracion.jpa.entities.InventarioComprasPK[ idInventario=" + idInventario + ", productoIdProducto=" + productoIdProducto + ", proveedorTipoDocumento=" + proveedorTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
