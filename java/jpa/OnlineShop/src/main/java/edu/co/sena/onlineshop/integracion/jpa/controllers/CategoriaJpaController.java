    ...
    public void create(Categoria categoria) {
        ...
        try {
            ...
            for (Producto productoCollectionProducto : categoria.getProductoCollection()) {
                Categoria oldCategoriaIdCategoriaOfProductoCollectionProducto = productoCollectionProducto.getCategoriaIdCategoria();
                productoCollectionProducto.setCategoriaIdCategoria(categoria);
                productoCollectionProducto = em.merge(productoCollectionProducto);
                if (oldCategoriaIdCategoriaOfProductoCollectionProducto != null) {
                    oldCategoriaIdCategoriaOfProductoCollectionProducto.getProductoCollection().remove(productoCollectionProducto);
                    oldCategoriaIdCategoriaOfProductoCollectionProducto = em.merge(oldCategoriaIdCategoriaOfProductoCollectionProducto);
                }
            }
        ...
        try {
            ...
            for (Producto productoCollectionOldProducto : productoCollectionOld) {
                if (!productoCollectionNew.contains(productoCollectionOldProducto)) {
                    ...
                    illegalOrphanMessages.add("You must retain Producto " + productoCollectionOldProducto + " since its categoriaIdCategoria field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Producto productoCollectionNewProducto : productoCollectionNew) {
                if (!productoCollectionOld.contains(productoCollectionNewProducto)) {
                    Categoria oldCategoriaIdCategoriaOfProductoCollectionNewProducto = productoCollectionNewProducto.getCategoriaIdCategoria();
                    productoCollectionNewProducto.setCategoriaIdCategoria(categoria);
                    productoCollectionNewProducto = em.merge(productoCollectionNewProducto);
                    if (oldCategoriaIdCategoriaOfProductoCollectionNewProducto != null && !oldCategoriaIdCategoriaOfProductoCollectionNewProducto.equals(categoria)) {
                        oldCategoriaIdCategoriaOfProductoCollectionNewProducto.getProductoCollection().remove(productoCollectionNewProducto);
                        oldCategoriaIdCategoriaOfProductoCollectionNewProducto = em.merge(oldCategoriaIdCategoriaOfProductoCollectionNewProducto);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (Producto productoCollectionOrphanCheckProducto : productoCollectionOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Categoria (" + categoria + ") cannot be destroyed since the Producto " + productoCollectionOrphanCheckProducto + " in its productoCollection field has a non-nullable categoriaIdCategoria field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
