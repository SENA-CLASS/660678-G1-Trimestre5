...
import edu.co.sena.onlineshop.integracion.jpa.controllers.CategoriaJpaController;
 ...
 * @author hernando
 */
public class CategoriaControllerEclipselink {
    ...
    public static void main(String[] args) {
        ...
        CategoriaJpaController cc = new CategoriaJpaController(emf1);
        cc.create(c1);
