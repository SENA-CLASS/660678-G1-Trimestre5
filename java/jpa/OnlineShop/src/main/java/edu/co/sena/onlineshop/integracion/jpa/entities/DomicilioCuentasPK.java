...
public class DomicilioCuentasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.onlineshop.integracion.jpa.entities.DomicilioCuentasPK[ cuentaTipoDocumento=" + cuentaTipoDocumento + ", cuentaNumeroDocumento=" + cuentaNumeroDocumento + " ]";
    }
