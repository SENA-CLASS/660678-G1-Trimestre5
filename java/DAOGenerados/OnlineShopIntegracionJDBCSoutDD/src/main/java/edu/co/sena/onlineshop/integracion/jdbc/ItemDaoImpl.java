...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	public ItemPk insert(Item dto) throws ItemDaoException
	{
		...
		try {
			...
			if (dto.isCostoUnitarioModified()) {
				stmt.setString( index++, dto.getCostoUnitario() );
			}
		
			if (dto.isCostoTotalModified()) {
				stmt.setString( index++, dto.getCostoTotal() );
			}
	 ...
	 */
	public Item[] findWhereCostoUnitarioEquals(String costoUnitario) throws ItemDaoException
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE COSTO_UNITARIO = ? ORDER BY COSTO_UNITARIO", new Object[] { costoUnitario } );
	}

	/** 
	 * Returns all rows from the item table that match the criteria 'COSTO_TOTAL = :costoTotal'.
	 */
	public Item[] findWhereCostoTotalEquals(String costoTotal) throws ItemDaoException
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE COSTO_TOTAL = ? ORDER BY COSTO_TOTAL", new Object[] { costoTotal } );
	}
	...
	protected void populateDto(Item dto, ResultSet rs) throws SQLException
	{
		...
		dto.setCostoUnitario( rs.getString( COLUMN_COSTO_UNITARIO ) );
		dto.setCostoTotal( rs.getString( COLUMN_COSTO_TOTAL ) );
