...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	protected static final Logger logger = Logger.getLogger( DomicilioCuentasDaoImpl.class );
	...
	public DomicilioCuentasPk insert(DomicilioCuentas dto) throws DomicilioCuentasDaoException
	{
		...
		try {
			...
			if (dto.isCorreoPostalModified()) {
				if (modifiedCount>0) {
					sql.append( ", " );
					values.append( ", " );
				}
		
				sql.append( "CORREO_POSTAL" );
				values.append( "?" );
				modifiedCount++;
			}
	...
	public void update(DomicilioCuentasPk pk, DomicilioCuentas dto) throws DomicilioCuentasDaoException
	{
		...
		try {
			...
			sql.append( " WHERE CUENTA_NUMERO_DOCUMENTO=? AND CUENTA_TIPO_DOCUMENTO=?" );
			if (logger.isDebugEnabled()) {
				logger.debug( "Executing " + sql.toString() + " with values: " + dto);
			}
	...
	protected void reset(DomicilioCuentas dto)
	{
		...
		dto.setCorreoPostalModified( false );
