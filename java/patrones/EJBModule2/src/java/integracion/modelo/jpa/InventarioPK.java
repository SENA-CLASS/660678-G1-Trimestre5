...
public class InventarioPK implements Serializable {
    ...
    public InventarioPK(int idInventario, String productoIdProducto, String proveedorTipoDocumento, String proveedorNumDocumento) {
    ...
    public String toString() {
        return "integracion.modelo.jpa.InventarioPK[ idInventario=" + idInventario + ", productoIdProducto=" + productoIdProducto + ", proveedorTipoDocumento=" + proveedorTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
