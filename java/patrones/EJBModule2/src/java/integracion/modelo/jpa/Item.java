...
@NamedQueries({
    ...
    @NamedQuery(name = "Item.findByPedidoIdPedido", query = "SELECT i FROM Item i WHERE i.itemPK.pedidoIdPedido = :pedidoIdPedido"),
...
public class Item implements Serializable {
    ...
    public Item(String productoIdProducto, int pedidoIdPedido) {
        this.itemPK = new ItemPK(productoIdProducto, pedidoIdPedido);
    }
    ...
    public String toString() {
        return "integracion.modelo.jpa.Item[ itemPK=" + itemPK + " ]";
    }
